...
<div class="row" style=" margin-bottom:50px; margin-top: 100px">
    ...
    <div class="order-common col-12 col-xl-5 col-lg-5 col-md-6">
            ...
            <form action="/dashboard/order-manager/generate-order" method="post" >
                ...
                <div class="form-group">
                    <label for="phone">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="phone" id="phone" placeholder="Customer Phone's number ..." require pattern="^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$" value="<?php if (isset($_SESSION["phone"]) && $_SESSION["phone"]) {echo ($_SESSION["phone"]);} ?>">
