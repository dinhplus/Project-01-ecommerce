<?php if (count($cart) > 0) { ?>
    ...
    <div class="row col-12 col-xl-12" style=" margin-bottom:50px; margin-top: 100px">

        <div class="order-detail col-6 col-xl-5 col-lg-5 col-md-6">
            ...
            <div class="list-item" style="margin-left: 50px; overflow: auto">
                <?php foreach ($cart as $item) { ?>
                    <div class="row" style="border: 1px solid blue; border-collapse:collapse; margin-bottom: 30px; padding: 20px; border-radius: 10px">
                        ...
                        <div class="item-img col-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <a href="<?= "http://" . HOST . "/dashboard/product-manager/product-detail?pid=" . $item["id"] ?>">
                        ...
                        <div class="content-summary col-6 col-xl-6 col-lg-5 col-md-4 col-sm-11" style="margin-left: 10px; ">
                            <b>
                                <h3>
                                    <?= $item["name"] ?>
                                </h3>
                            ...
                            <div class="item-action row">
                                ...
                                <div class="delete-item">
                                    <form action="<?= "http://" . HOST . "/dashboard/order-manager/delete-temp-item" ?>" method="POST">
                                ...
                                <div class="change-qtt">
                                    ...
                                    <form action="<?= "http://" . HOST . "/dashboard/order-manager/update-temp-item-quantity" ?>" method="post" id="<?= "formQtt-" . $item["id"] ?>" style="display: none;">
        ...
        <div class="order-common col-5 col-xl-5 col-lg-4 col-md-4" style="position: fixed; right:0px">
            <div class="customer-detail" style="border: 1px solid blue; padding: 20px; border-radius: 10px; margin: 10px; width:90%">
                <hr>
                <h2>
                    Confirm consignee information
                </h2>
                <hr>
                <form action="/dashboard/order-manager/generate-order" method="post">
                    ...
                    <div class="form-group">
                        <label for="name">
                            ...
                            <input type="text" class="form-control" name="name" id="name" placeholder="Customer name ..." require value="<?php if (isset($_SESSION["name"]) && $_SESSION["name"]) {
                                                                                                                                                echo ($_SESSION["name"]);
                                                                                                                                            }
                                                                                                                                            ?>">
                    ...
                    <div class="form-group">
                        <label for="phone">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="phone" id="phone" placeholder="Customer Phone's number ..." require pattern="^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$" value="<?php if (isset($_SESSION["phone"]) && $_SESSION["phone"]) {
                                                                                                                                                                                                                    echo ($_SESSION["phone"]);
                                                                                                                                                                                                                } ?>">
                    ...
                    <div class="form-group">
                        ...
                        <label for="address">
                            <textarea type="text" rows="2" cols="50" class="form-control" name="address" id="address" placeholder="Customer's adress ..." require parent="[\w]{5,}"><?php if (isset($_SESSION["address"]) && $_SESSION["address"]) {
...
<?php } else echo (" <br> <br> <br> <br><center> <h1> The temporary shopping cart is currently empty</h1> </center>") ?>